...
const helmetSchema = new Schema(
  {
    ...
    magicLevel: {
      type: Number,
      required: [true, "Falta el campo magic level"],
    },
    speed: { type: Number, required: [true, "Falta el campo speed"] },
    imbuSlot: { type: Number, required: [true, "Falta el campo imbu slot"] },
    iceDefense: {
      type: Number,
      required: [true, "Falta el campo ice defense"],
    },
    earthDefense: {
      type: Number,
      required: [true, "Falta el campo earth defense"],
    },
    fireDefense: {
      type: Number,
      required: [true, "Falta el campo fire defense"],
    },
    energyDefense: {
      type: Number,
      required: [true, "Falta el campo energy defense"],
    },
    physicalDefense: {
      type: Number,
      required: [true, "Falta el campo physical defense"],
    },
